...
image:https://img.shields.io/maven-central/v/de.cuioss.portal.ui/cui-portal-ui.svg?label=Maven%20Central["Maven Central", link="https://search.maven.org/artifact/de.cuioss.portal.ui/cui-portal-ui"]
